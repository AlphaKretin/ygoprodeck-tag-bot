...
exports.updateTagMap = exports.fullTagNames = exports.tagMap = void 0;
var config_json_1 = require("../config.json");
var util_1 = require("./util");
var node_fetch_1 = __importDefault(require("node-fetch"));
exports.tagMap = {};
exports.fullTagNames = [];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    exports.fullTagNames = halves[0].split(/\r\n|\r|\n/).filter(function (v) { return v !== ""; });
                    tags = exports.fullTagNames.map(util_1.cleanString);
                    links = halves[1].split(/\r\n|\r|\n/).filter(function (v) { return v !== ""; });
                    exports.tagMap = {};
                    for (i = 0; i < Math.min(tags.length, links.length); i++) {
                        exports.tagMap[tags[i]] = links[i];
                    }
                    return [2 /*return*/];
            }
        });
...
exports.updateTagMap = updateTagMap;
